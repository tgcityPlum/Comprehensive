...
/**
 * copy了系统V4包中的Fragment，将 show(FragmentManager manager, String tag)方法中的ft.commit()改为了ft.commitAllowingStateLoss()，
 * 用来修复java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState的问题
 */
public class DialogFragmentV4 extends Fragment
