package com.tgcity.refreshview.springview.widget;
...
//        contentLay.bringToFront(); //把内容放在最前端
    ...
    public void setResult(Throwable e, OnExceptionEventClickListener onExceptionEventClickListener) {
        ...
        if (e instanceof ApiException) {
            if (ErrorMode.OVERLOAD.equals(((ApiException) e).errorMode)) {
                setErrorTitleAndDesc(getResources().getString(R.string.ERROR_OVERLOAD_TITLE), getResources().getString(R.string.ERROR_OVERLOAD_DESC));
            }
            if (ErrorMode.NO_CACHE.equals(((ApiException) e).errorMode)) {
                setErrorTitleAndDesc(getResources().getString(R.string.ERROR_NO_CACHE_TITLE), getResources().getString(R.string.ERROR_NO_CACHE_DESC));
            }
            ...
            if (ErrorMode.CONNECT_TIME_OUT.equals(((ApiException) e).errorMode)) {
                setErrorTitleAndDesc(getResources().getString(R.string.ERROR_CONNECT_TIME_OUT_TITLE), getResources().getString(R.string.ERROR_NO_CACHE_DESC));
            }
            if (ErrorMode.UNKNOWN_HOST.equals(((ApiException) e).errorMode)) {
                setErrorTitleAndDesc(getResources().getString(R.string.ERROR_UNKNOWN_HOST_TITLE), getResources().getString(R.string.ERROR_SINGNATURE_FAILURE_SSL_DESC));
            }
    ...
    public interface OnExceptionEventClickListener {
        void onExceptionClick(ErrorMode errorMode, Context context);
    }
}
