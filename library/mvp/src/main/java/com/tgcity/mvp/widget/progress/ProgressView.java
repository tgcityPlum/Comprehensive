...
import com.tgcity.mvp.R;
import com.tgcity.mvp.utils.ErrorEventOperation;
import com.tgcity.mvp.utils.GameCountDownTimerUtils;
...
public class ProgressView extends ProgressActivity {
    ...
    private int normalErrorButtonTextColor = getResources().getColor(R.color.progress_activity_error_button_text_color_normal);
    private int stopErrorButtonTextColor = getResources().getColor(R.color.progress_activity_error_button_text_color_stop);
...
//                            RouteHelper.with(VipIntroduceActivity.class).build();
    ...
    private void startCountDown() {
        ...
        gameCountDownTimerUtils = new GameCountDownTimerUtils(NetworkConstant.Service.SERVICE_TRY_WAIT, NetworkConstant.Service.SERVICE_TRY_INTERVAL) {
            @Override
