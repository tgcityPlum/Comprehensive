...
package com.tgcity.mode.media.h264.manage;
...
public class EncoderDebugger {
    ...
    /**
     * This {@link NV21Convert} will do the necessary work to feed properly
     * the encoder.
     */
    ...
    private void debug() {
        ...
        int count = 0, n = 1;
        for (CodecManager.Codec encoder : encoders) {
            count += encoder.formats.length;
        }
        ...
        for (CodecManager.Codec encoder : encoders) {
            for (int j = 0; j < encoder.formats.length; j++) {
                ...
                // /!\ NV21Convert can directly modify the input
                createTestImage();
